            ...
            <Carousel variant="dark" fade>
              <Carousel.Item className="d-block w-100 h-100">
                <div
                  ...
                  <p>
                    Tidio has given our clients a quick and easy way to send
                    over thoughts and questions without delay or wait time! No
                    second guessing – just asked and answered quickly in order
                    to make their purchasing decisions easier!
                  </p>
