            ...
            <div className="c-bg"></div>
                <div className="c-wrapper">
                    ...
                    <div className="c-right">
                            ...
                            <textarea style={{backgroundColor: darkMode && "#333"}} name="message" placeholder="Massage" rows="5"></textarea>
                            <button style={{backgroundColor: darkMode && "#333"}} className='btn'>Submit</button>
